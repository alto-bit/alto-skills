...
| **목적 (Goal)** | 이 스킬이 달성해야 하는 결과 | "Alto 코딩 규약에 맞는 코드를 작성한다" |
...
```markdown
---
name: alto-coding-convention
description: Alto C# 코딩 규약을 적용할 때 사용합니다.
...
## 역할
Unity C# 시니어 개발자로서 Alto 코딩 규약에 맞는 코드를 작성한다.
...
```
.claude/skills/alto-coding-convention/
...
---
name: alto-coding-convention
description: Alto C# 코딩 규약을 적용합니다.
...
You are a Unity C# developer following Alto's coding conventions.
...
✅ 적절한 범위
"Unity C# 코드 작성 시 Alto 코딩 규약(네이밍, 접근 한정자, enum 규약)을 따른다."
```
...
자세한 내용은 **Alto 소스코드 및 내부자료 보안** 문서를 참고하세요.
> 
...
✅ 목적별로 분리
- alto-coding-convention (코딩 규약)
- alto-folder-convention (폴더 규약)
- alto-git-convention (Git 규약)
```
...
예시:
alto_coding_convention.md
alto_folder_convention.md
alto_git_convention.md
alto_pr_review.md
```
