...
> Alto 웹앱(React + TypeScript / Next.js) 코딩 규약을 AI 도구에 스킬로 등록하여,
...
웹앱 코딩 규약 스킬은 Alto의 **React + TypeScript 코딩 규약**을 AI 도구가 코드 작성 시 자동으로 참고하도록 만든 지침 파일입니다.
...
```
# Alto Web App Coding Convention
...
```markdown
---
description: Alto 웹앱 코딩 규약. TypeScript/React 코드 작성, 리팩토링, 리뷰 시 자동으로 참고됩니다.
globs: src/**/*.{ts,tsx}
alwaysApply: false
---
...
1. `.claude/skills/alto-webapp-coding-convention/SKILL.md`에 3-1 내용을 저장합니다.
2. 코드 작성 시 자동으로 참고됩니다.

### 4-2. Codex CLI

1. `.codex/skills/alto-webapp-coding-convention/SKILL.md`에 3-1 내용을 저장합니다.
...
```markdown
| alto-webapp-coding-convention | 웹앱 코딩 규약 (React+TS 네이밍, 컴포넌트, 타입) | ✅ 사용중 | SKILL.md | v1.0 | 2026-05-28 |
```
