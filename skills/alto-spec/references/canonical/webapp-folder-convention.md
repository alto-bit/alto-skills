...
> Alto 웹앱(React + TypeScript / Next.js) 폴더 규약을 AI 도구에 스킬로 등록하여,
...
웹앱 폴더 규약 스킬은 Alto의 **Next.js App Router 기반 폴더 구조 규약**을 AI 도구가 파일 생성 시 자동으로 참고하도록 만든 지침 파일입니다.
...
```
# Alto Web App Folder Convention
...
```markdown
---
description: Alto 웹앱 폴더 규약. 파일 생성, 이동, 구조 변경 시 자동으로 참고됩니다.
globs: src/**/*
alwaysApply: false
---
...
1. `.claude/skills/alto-webapp-folder-convention/SKILL.md`에 3-1 내용을 저장합니다.
2. 파일 생성 시 자동으로 참고됩니다.

### 4-2. Codex CLI

1. `.codex/skills/alto-webapp-folder-convention/SKILL.md`에 3-1 내용을 저장합니다.
...
```markdown
| alto-webapp-folder-convention | 웹앱 폴더 구조 및 파일 배치 규약 | ✅ 사용중 | SKILL.md | v1.0 | 2026-05-28 |
```
